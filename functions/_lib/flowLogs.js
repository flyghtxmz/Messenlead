...
const COMPACT_INFO_EVENTS = new Set([
  ...
  "delay_resuming",
  "condition_continuation_woken_by_click",
  ...
  "url_button_click_resuming",
  "url_button_click_continuations_drained",
  "condition_result",
  "send_success",
  "manual_log_test",
...
const COMPACT_WARN_EVENTS = new Set([
  ...
  "delay_workflow_schedule_failed",
  ...
  "url_button_click_no_next",
  "url_button_click_action_without_next",
